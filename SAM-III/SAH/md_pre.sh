######## 1 ########
mkdir 1_modeling
grep -E '^(ATOM|HETATM)' 1_3e5e.pdb > 2_3e5e.pdb # delete SO4

# Avogadro add H & Extensions--Optimize Geometry

antechamber -fi mol2 -i 2_3e5e_N_SAH_opt.mol2 -fo gcrt -o sah.gau -nc 0
module load gaussian
g16 < sah.gau > sah.out # Pos +1 Neg -1
antechamber -fi gout -i sah.out -fo ac -o sah.ac -c resp


antechamber -fi ac -i sah.ac -fo ac -o sah-renamed.ac -fa mol2 -a 2_3e5e_N_SAH_opt.mol2 -ao name -at gaff2 -rn sah
antechamber -fi ac -i sah-renamed.ac -fo mol2 -o sah.mol2
parmchk2 -f mol2 -i sah.mol2 -o sah.frcmod
...
cd 2_md-preparation
pdb4amber -i ../1_modeling/2_3e5e.pdb -o sys.pdb
tleap
...
source leaprc.gaff2
loadAmberParams ../1_modeling/sah.frcmod
sah = loadmol2 ../1_modeling/sah.mol2
saveamberparm sah sys.inpcrd sys.prmtop
saveoff sah ../sah.lib
...
solvatebox sys OPCBOX {7.7 12.68 20.6}
