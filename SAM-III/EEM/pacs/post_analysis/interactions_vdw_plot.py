...
fig, ax = plt.subplots(1,52)
fig.set_size_inches(92, 3)

for residue_index_rna in range(0, 52):
...
fig.tight_layout()
fig.savefig("./figures/vdw1.png", dpi=300, bbox_inches="tight")


fig, ax = plt.subplots(len(pacs_interactions), 52)
...
for trial in range(len(pacs_interactions)):
    for residue_index_rna in range(0, 52):
        ...
        ax[trial, residue_index_rna].set_ylim(0, 30)

fig.tight_layout()
fig.savefig("./figures/vdw2.png", dpi=300, bbox_inches="tight")
...
for residue_index_rna in range(0, 52):
    ...
    ax[residue_index_rna].set_title(gleap_target.topology.residue(residue_index_rna))
    ax[residue_index_rna].set_ylim(0, 30)

fig.tight_layout()
fig.savefig("./figures/vdw3.png", dpi=300, bbox_inches="tight")
