...
BASE_DIR = "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/EEM/test_trial/pacs"
...
def worker(trial):
    ...
    plt.title(trial)
    plt.legend()
    plt.savefig('/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/EEM/test_trial/pacs/post_analysis/figures/' + str(trial+1) + '.png',dpi=200)
    plt.close()
