######## 1 ########
mkdir 1_modeling
grep -E '^(ATOM|HETATM)' 1_3E5F.pdb > 2_3E5F.pdb # delete SO4

# Avogadro add H & Extensions--Optimize Geometry

antechamber -fi mol2 -i 2_3e5f_Q_EEM_opt.mol2 -fo gcrt -o eem.gau -nc 0
module load gaussian/16
g16 < eem.gau > eem.out # Pos +1 Neg -1
antechamber -fi gout -i eem.out -fo ac -o eem.ac -c resp


antechamber -fi ac -i eem.ac -fo ac -o eem-renamed.ac -fa mol2 -a 2_3e5f_Q_EEM_opt.mol2 -ao name -at gaff2 -rn eem
antechamber -fi ac -i eem-renamed.ac -fo mol2 -o eem.mol2
parmchk2 -f mol2 -i eem.mol2 -o eem.frcmod
...
cd 2_md-preparation
pdb4amber -i ../1_modeling/2_3e5f.pdb -o sys.pdb
tleap
...
source leaprc.gaff2
loadAmberParams ../1_modeling/eem.frcmod
eem = loadmol2 ../1_modeling/eem.mol2
saveamberparm eem sys.inpcrd sys.prmtop
saveoff eem ../eem.lib
...
solvatebox sys OPCBOX {13.6 8.68 21}
...
cd 3_min-1
cp ../min-1.mdp .
gmx_mpi grompp -f min-1.mdp -c ../2_md-preparation/gleap.gro -p ../2_md-preparation/gleap.top -n ../2_md-preparation/gleap.ndx -r ../2_md-preparation/gleap.gro -o min.tpr -maxwarn 1
...
cd 4_nvt-1
cp ../nvt-1.mdp .
gmx_mpi grompp -f nvt-1.mdp -c ../3_min-1/min.gro -p ../2_md-preparation/gleap.top -n ../2_md-preparation/gleap.ndx -r ../2_md-preparation/gleap.gro -o nvt.tpr -maxwarn 1
