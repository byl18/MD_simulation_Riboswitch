...
systems = {
    "SAM": {
        ...
        "pickle_dir": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/SAM/test_trial/pacs/post_analysis/pickle-cache/interactions_pi-stacking",
    },
    "SAH": {
        "color": "blue",
        "top": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/SAH/test_trial/2_md-preparation/gleap.target.gro",
        "pickle_dir": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/SAH/test_trial/pacs/post_analysis/pickle-cache/interactions_pi-stacking",
    },
    "EEM": {
        "color": "yellow",
        "top": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/EEM/test_trial/2_md-preparation/gleap.target.gro",
        "pickle_dir": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/SAM/EEM/test_trial/pacs/post_analysis/pickle-cache/interactions_pi-stacking",
    },
}
...
os.makedirs("./figures/residue_pi-stacking_compare", exist_ok=True)
...
for residue_index_rna in range(52):
    ...
    ax_line.set_title(f"{residue} pi-pi stacking changes")
    ax_line.set_xlabel("Ligand–RNA distance bin")
    ax_line.set_ylabel("pi-pi stacking frequency")
    ...
    ax_box.set_ylabel("Mean pi-pi stacking frequency")

    fig.suptitle(f"{residue}", fontsize=14)
    fig.tight_layout()

    fig.savefig(
        f"./figures/residue_pi-stacking_compare/residue_{residue_index_rna:02d}_{residue}_pi-stacking_compare.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig)