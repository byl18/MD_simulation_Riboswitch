######## 1 ########
mkdir 1_modeling
grep ATOM 1_6VUH.pdb > 2_6VUH.pdb

######## 2 ########
mkdir 2_md-preparation
cd 2_md-preparation
pdb4amber -i ../1_modeling/2_6VUH.pdb -o sys.pdb
tleap
...
# Ctrl+Z to validate automatically added atoms by difp
solvatebox sys OPCBOX {25 20.7 15}
...
#### What have I missed?
# add posre_Target.top-directive to the gleap RNA(mol) part behind.
...
# nohup mpirun -np 48 gmx_mpi mdrun -deffnm cmd > 6.log 2>&1 &
