...
cd 2_md-preparation
pdb4amber -i ../1_modelling/XXX.pdb -o sys.pdb
tleap
python3 $WORKSPACE_DIR/programs/amber2gromacs.py leap gleap
...
echo C-alpha | gmx_mpi trjconv -s gleap.target.gro -f gleap.target.gro -o gleap.target.ca.gro
selections=( "Target" "Protein" "Rna" "Dna" "ProteinNmr" "RnaNmr" "DnaNmr" )
...
cd 4_nvt-2
cp ../nvt-2.mdp .
gmx_mpi grompp -f nvt-2.mdp -c ../4_nvt-1/nvt.gro -t ../4_nvt-1/nvt.cpt -p ../2_md-preparation/gleap.top -n ../2_md-preparation/gleap.ndx -r ../2_md-preparation/gleap.gro -o nvt.tpr
gmd -deffnm nvt
echo Temperature | gmx_mpi energy -f nvt.edr -o Temperature.xvg
gmx_mpi trjconv -s nvt.tpr -f nvt.gro -n ../2_md-preparation/gleap.ndx -o nvt.whole.gro -pbc whole <<EOF
System
...
do
    ...
    gmx_mpi grompp -f npt-1.mdp -c $prev_run.gro -t $prev_run.cpt -p ../2_md-preparation/gleap.top -n ../2_md-preparation/gleap.ndx -r ../2_md-preparation/gleap.gro -o npt.tpr
    gmd -deffnm npt
...
cd 6_cmd-1
cp ../cmd.mdp .
gmx_mpi grompp -f cmd.mdp -c ../5_npt-10/npt.gro -t ../5_npt-10/npt.cpt -p ../2_md-preparation/gleap.top -n ../2_md-preparation/gleap.ndx -o cmd.tpr
