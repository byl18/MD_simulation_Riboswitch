...
systems = {
    "PreQ0": {
        ...
        "pickle_dir": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/PreQ0/trial01/pacs2/post_analysis/pickle-cache/interactions_vdw",
    },
    "PreQ1": {
        "color": "blue",
        "top": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/PreQ1/trial01/2_md-preparation/gleap.target.gro",
        "pickle_dir": "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/PreQ1/trial01/pacs2/post_analysis/pickle-cache/interactions_vdw",
    },
}
...
os.makedirs("./figures/residue_vdw_compare", exist_ok=True)
...
for residue_index_rna in range(33):
    ...
    ax_line.set_title(f"{residue} vdw changes")
    ax_line.set_xlabel("Ligand–RNA distance bin")
    ax_line.set_ylabel("vdw frequency")
    ...
    ax_box.set_ylabel("Mean vdw frequency")

    fig.suptitle(f"{residue}", fontsize=14)
    fig.tight_layout()

    fig.savefig(
        f"./figures/residue_vdw_compare/residue_{residue_index_rna:02d}_{residue}_vdw_compare.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig)