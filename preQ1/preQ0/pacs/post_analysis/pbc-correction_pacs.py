...
BASE_DIR = "/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/PreQ0/trial01/pacs2"
...
def worker(trial):
    ...
    plt.title(trial)
    plt.legend()
    plt.savefig('/gs/bs/tga-KitaoLab-NexusYtec/yilan/projects/PreQ0/trial01/pacs2/post_analysis/figures/' + str(trial+1) + '.png',dpi=200)
    plt.close()
