...
mkdir 1_modeling
cd 1_modeling
grep -E '^(ATOM|HETATM)' 1_3gca.pdb > 2_3gca.pdb # delete SO4

antechamber -fi mol2 -i 2_3gca_B_PQ0.mol2 -fo gcrt -o pq0.gau -nc 0
g16 < pq0.gau > pq0.out
antechamber -fi gout -i pq0.out -fo ac -o pq0.ac -c resp


antechamber -fi ac -i pq0.ac -fo ac -o pq0-renamed.ac -fa mol2 -a 2_3gca_B_PQ0.mol2 -ao name -at gaff2 -rn pq0
antechamber -fi ac -i pq0-renamed.ac -fo mol2 -o pq0.mol2
parmchk2 -f mol2 -i pq0.mol2 -o pq0.frcmod
...
cd 2_md-preparation
pdb4amber -i ../1_modeling/2_3gca.pdb -o sys.pdb
tleap
...
source leaprc.gaff2
loadAmberParams ../1_modeling/pq0.frcmod
PQ0 = loadmol2 ../1_modeling/pq0.mol2
saveamberparm PQ0 sys.inpcrd sys.prmtop
saveoff PQ0 ../PQ0.lib
...
# add posre_RNA.top-directive to the gleap.top [moleculetype]
...
# gmx_mpi trjconv -f cmd.xtc -s cmd.tpr -n ../2_md-preparation/gleap.ndx -o nopbc.xtc -center -pbc mol
